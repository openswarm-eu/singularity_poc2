...
# some more aliases
alias ws='cd; cd singularity_openswarm/user_ros_workspace/'
alias bag='roscd mrs_openswarm_real/tmux/swarm_formation/; ./start.sh'
alias one='roscd mrs_openswarm_simulation/tmux/one_drone_3dlidar/; ./start.sh'
alias swarm='roscd mrs_openswarm_simulation/tmux/three_drones_swarm/; ./start.sh'